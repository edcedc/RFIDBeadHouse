package com.yyc.beadhouse.util;
...
public class DatePickerUtils {
    ...
    public static void getYearMonthDayPicker(Activity act, String title, final OnYearMonthDayListener listener){
        ...
        picker.setSubmitText(act.getText(R.string.release_success) + "  ");
        picker.setGravity(Gravity.BOTTOM);
        picker.setSubmitTextColor(act.getColor(R.color.colorPrimaryDark));
        picker.setCanLoop(true);
        picker.setSelectedTextColor(act.getColor(R.color.colorPrimaryDark));
        picker.setTopPadding(15);
//        picker.setRangeStart(year, mon, day);
        picker.setRangeEnd(year + 10, 11, 11);
